...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, colframe=quarto-callout-warning-color-frame, colbacktitle=quarto-callout-warning-color!10!white, breakable, toprule=.15mm, bottomtitle=1mm, opacitybacktitle=0.6, toptitle=1mm, opacityback=0, rightrule=.15mm, bottomrule=.15mm, colback=white, left=2mm, titlerule=0mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{警告}, arc=.35mm, leftrule=.75mm]
...
{\centering \includegraphics{figures/causal_modeling.png}
...
{\centering \includegraphics{figures/word_embeddings.png}
...
{\centering \includegraphics{figures/word_embeddings2.png}
...
{\centering \includegraphics{figures/transformers.png}
...
{\centering \includegraphics{figures/Reinforcement_learning_diagram.svg.png}
...
{\centering \includegraphics{figures/instructGPT.png}
...
{\centering \includegraphics{figures/agan.jpeg}
...
{\centering \includegraphics{figures/ai_co2.png}
...
{\centering \includegraphics{figures/acemoglu.png}
