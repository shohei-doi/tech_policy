...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, toptitle=1mm, breakable, left=2mm, rightrule=.15mm, toprule=.15mm, colback=white, coltitle=black, opacitybacktitle=0.6, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{警告}, titlerule=0mm, bottomtitle=1mm, bottomrule=.15mm, colbacktitle=quarto-callout-warning-color!10!white, colframe=quarto-callout-warning-color-frame, leftrule=.75mm, opacityback=0]
