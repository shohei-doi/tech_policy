...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, toprule=.15mm, bottomtitle=1mm, colframe=quarto-callout-warning-color-frame, rightrule=.15mm, arc=.35mm, titlerule=0mm, leftrule=.75mm, colback=white, toptitle=1mm, colbacktitle=quarto-callout-warning-color!10!white, breakable, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{警告}, opacitybacktitle=0.6, coltitle=black, bottomrule=.15mm, left=2mm]
