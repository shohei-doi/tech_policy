...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, colframe=quarto-callout-warning-color-frame, bottomrule=.15mm, rightrule=.15mm, toprule=.15mm, coltitle=black, colbacktitle=quarto-callout-warning-color!10!white, opacitybacktitle=0.6, colback=white, bottomtitle=1mm, arc=.35mm, breakable, toptitle=1mm, titlerule=0mm, left=2mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{警告}, leftrule=.75mm]
...
{\centering \includegraphics{figures/homophily1.png}
...
{\centering \includegraphics{figures/homophily2.png}
...
{\centering \includegraphics{figures/partisanship_climate_change.png}
...
{\centering \includegraphics{figures/bakshy.png}
...
{\centering \includegraphics{figures/flaxman1.jpeg}
...
{\centering \includegraphics{figures/flaxman2.jpeg}
...
{\centering \includegraphics{figures/bot1.jpg}
...
{\centering \includegraphics{figures/bot2.jpg}
...
{\centering \includegraphics{figures/vosoughi.jpeg}
