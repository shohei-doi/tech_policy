...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-warning-color-frame, toprule=.15mm, titlerule=0mm, breakable, colbacktitle=quarto-callout-warning-color!10!white, colback=white, toptitle=1mm, left=2mm, rightrule=.15mm, opacityback=0, leftrule=.75mm, coltitle=black, arc=.35mm, bottomtitle=1mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{警告}, bottomrule=.15mm, opacitybacktitle=0.6]
