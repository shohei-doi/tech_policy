...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, colback=white, arc=.35mm, opacitybacktitle=0.6, bottomtitle=1mm, colframe=quarto-callout-warning-color-frame, breakable, left=2mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{警告}, coltitle=black, colbacktitle=quarto-callout-warning-color!10!white, toptitle=1mm, titlerule=0mm, toprule=.15mm, bottomrule=.15mm, opacityback=0, leftrule=.75mm]
